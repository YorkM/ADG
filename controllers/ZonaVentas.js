...
$.ajax({     
	...
	if(data.length>0){
	  ...
	  let tb='<table class="table table-sm table-striped table-hover" >'+
				'<thead class="thead_fijo"  >'+
				  '<tr>'+
		...
		if (e.target.files != undefined) {
				...
				var csvval= e.target.result.split("\n");
					...
					if(valido){
						...
						let tb='<table class="table datos_csv ">'+
								 '<thead>'+
									'<tr>'+
										'<th>ZONA VENTA</th>'+
