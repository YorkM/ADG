...
<body>
  ...
  <div class="alert alert-info"><i class="fa-solid fa-star fa-flip"></i>&nbsp;0312 - ADMINISTRACIÓN DE CONVENIOS</div>
  <!-- OPCIONES DE TABS -->
  <div class="tabs-header">
    <ul class="nav nav-tabs" id="borderedTab" role="tablist">
      <li class="nav-item" id="liCreacion" role="presentation">
        <button class="nav-link active size-15"
          id="tabCreacion"
          data-bs-toggle="tab"
  ...
  <div class="tab-content" id="borderedTabContent">
    <!-- TAB CREACIÓN -->
    <div class="tab-pane fade p-2 show active" id="dvCreacion" role="tabpanel">
      <div class="container-fluid">
        <div class="row">
                ...
                <form class="row g-3">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="input-group">
                      ...
                      <select id="inSociedad" class="form-select shadow-sm size-13"></select>
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="input-group">
                      <select id="centro" class="form-select shadow-sm size-13" multiple>
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="input-group">
                      <span class="input-group-text bg-light"><i class="fa-solid fa-handshake"></i></span>
                      <select id="tipoConvenio" class="form-select shadow-sm size-13">
                        <option value="" selected>--Seleccione Tipo Convenio--</option>
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="input-group">
                      <select id="inGrupoArticulo" class="form-control shadow-sm size-13" multiple style="width:100%"></select>
                    </div>
                  </div>
                  ...
                  <div class="col-12">
                    ...
                    <div class="input-group">
                      ...
                      <input type="email" id="txtEmail" class="form-control shadow-sm size-13" placeholder="Email" autocomplete="off">
                    </div>
                  </div>
                  ...
                  <div class="col-12">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" id="txtDescripcion" class="form-control shadow-sm size-13" placeholder="Descripción" autocomplete="off">
                    </div>
                  </div>
                    ...
                    <div class="row g-2">
                      <div class="col-md-6">
                        <div class="input-group">
                          ...
                          <input type="text" id="fhInicio" class="form-control shadow-sm" readonly placeholder="Fecha inicial">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="input-group">
                          <span class="input-group-text bg-light"><i class="fas fa-calendar "></i></span>
                          <input type="text" id="fhFinal" class="form-control shadow-sm" readonly placeholder="Fecha final">
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    ...
                    <input type="text" id="rebateTrimestre" class="form-control shadow-sm form-percent">
                  </div>

                  <div class="col-md-6">
                    <label for="rebateCodificacion"><i class="fas fa-percent me-2"></i>Rebate manejo de linea (Codificación)</label>
                    <input type="text" id="rebateCodificacion" class="form-control shadow-sm form-percent">
                  </div>

                  <div class="col-md-6">
                    <label for="rebateRotacion"><i class="fas fa-percent me-2"></i>Rebate x rotación</label>
                    <input type="text" id="rebateRotacion" class="form-control shadow-sm form-percent">
                  </div>

                  <div class="col-md-6">
                    <label for="rebateInformacion"><i class="fas fa-percent me-2"></i>Rebate x información</label>
                    <input type="text" id="rebateInformacion" class="form-control shadow-sm form-percent">
                  </div>

                  <div class="col-md-6">
                    <label for="rebateDevoluciones"><i class="fas fa-percent me-2"></i>Rebate no devoluciones</label>
                    <input type="text" id="rebateDevoluciones" class="form-control shadow-sm form-percent">
                  </div>

                  <div class="col-md-6">
                    <label for="rebateDinamica"><i class="fas fa-percent me-2"></i>Dinamica Comercial</label>
                    <input type="text" id="rebateDinamica" class="form-control shadow-sm form-percent">
                  </div>

                  <div class="col-md-6">
                    <label for="rebateInventario"><i class="fas fa-percent me-2"></i>Manejo dias inventario</label>
                    <input type="text" id="rebateInventario" class="form-control shadow-sm form-percent">
                  </div>

                  <div class="col-md-6">
                    <label for="rebateImpactos"><i class="fas fa-percent me-2"></i>Distribución numerica /impactos</label>
                    <input type="text" id="rebateImpactos" class="form-control shadow-sm form-percent">
                  </div>

                  <div class="col-md-6">
                    <label for="rebateLogistica"><i class="fas fa-percent me-2"></i>Logistica</label>
                    <input type="text" id="rebateLogistica" class="form-control shadow-sm form-percent">
                  </div>

                  <div class="col-md-6">
                    <label for="rebateOtros"><i class="fas fa-percent me-2"></i>Otros</label>
                    <input type="text" id="rebateOtros" class="form-control shadow-sm form-percent">
                  </div>
                  ...
                  <div class="col-md-6" style="display: none">
                    ...
                    <input type="text" id="rebateMes" class="form-control shadow-sm form-percent">
                  </div>

                  <div class="col-md-6" style="display: none">
                    <label for="rebateSemestre"><i class="fas fa-percent me-2"></i>Rebate Volumen Compras Semestre</label>
                    <input type="text" id="rebateSemestre" class="form-control shadow-sm form-percent">
                  </div>

                  <div class="col-md-6" style="display: none">
                    <label for="rebateAnio"><i class="fas fa-percent me-2"></i>Rebate Volumen Compras Año</label>
                    <input type="text" id="rebateAnio" class="form-control shadow-sm form-percent">
                  </div>
                </form>
              </div>
            </div>
          ...
          <div class="col-md-6">
            ...
            <div class="card mb-3">
              <div class="card-header alert-info">
                <h5 class="mb-0" id="tituloImpactos"><i class="fas fa-bullseye me-2"></i> OBJETIVOS TRIMESTRALES POR IMPACTOS</h5>
              </div>
              <div class="card-body">
                <form class="row g-3">
                  <!-- Trimestre 1 y 2 -->
                  <div class="col-md-6" id="impQ1">
                    <label for="Q1Impactos"><i class="fas fa-hashtag me-2"></i>Objetivo Impactos (Q1)</label>
                    <input type="text" id="Q1Impactos" class="form-control shadow-sm form-percent">
                  </div>
                  <div class="col-md-6" id="impQ2">
                    <label for="Q2Impactos"><i class="fas fa-hashtag me-2"></i>Objetivo Impactos (Q2)</label>
                    <input type="text" id="Q2Impactos" class="form-control shadow-sm form-percent">
                  </div>

                  <!-- Trimestre 3 y 4 -->
                  <div class="col-md-6" id="impQ3">
                    <label for="Q3Impactos"><i class="fas fa-hashtag me-2"></i>Objetivo Impactos (Q3)</label>
                    <input type="text" id="Q3Impactos" class="form-control shadow-sm form-percent">
                  </div>
                  <div class="col-md-6" id="impQ4">
                    <label for="Q4Impactos"><i class="fas fa-hashtag me-2"></i>Objetivo Impactos (Q4)</label>
                    <input type="text" id="Q4Impactos" class="form-control shadow-sm form-percent">
                  </div>

                  <!-- Campo oculto -->
                  <div class="col-md-12" style="display: none">
                    <label for="anioImpactos"><i class="fas fa-hashtag me-2"></i>Objetivo Impactos Año</label>
                    <input type="text" id="anioImpactos" class="form-control shadow-sm form-percent">
                  </div>
                </form>
              </div>
            </div>
            ...
            <div class="card mb-3">
              <div class="card-header alert-info">
                <h5 class="mb-0" id="tituloCompras"><i class="fas fa-chart-line me-2"></i> OBJETIVOS TRIMESTRALES POR COMPRAS</h5>
              </div>
              <div class="card-body">
                <form class="row g-3">
                  <!-- Trimestre 1 y 2 -->
                  <div class="col-md-6" id="comQ1">
                    <label for="Q1"><i class="fas fa-dollar-sign me-2"></i>Objetivo Compras (Q1)</label>
                    <input type="text" id="Q1" class="form-control shadow-sm form-percent">
                  </div>
                  <div class="col-md-6" id="comQ2">
                    <label for="Q2"><i class="fas fa-dollar-sign me-2"></i>Objetivo Compras (Q2)</label>
                    <input type="text" id="Q2" class="form-control shadow-sm form-percent">
                  </div>

                  <!-- Trimestre 3 y 4 -->
                  <div class="col-md-6" id="comQ3">
                    <label for="Q3"><i class="fas fa-dollar-sign me-2"></i>Objetivo Compras (Q3)</label>
                    <input type="text" id="Q3" class="form-control shadow-sm form-percent">
                  </div>
                  <div class="col-md-6" id="comQ4">
                    <label for="Q4"><i class="fas fa-dollar-sign me-2"></i>Objetivo Compras (Q4)</label>
                    <input type="text" id="Q4" class="form-control shadow-sm form-percent">
                  </div>

                  <!-- Campo oculto -->
                  <div class="col-md-12" style="display: none">
                    <label for="objetivoAnio"><i class="fas fa-dollar-sign me-2"></i>Objetivo Compras Año</label>
                    <input type="text" id="objetivoAnio" class="form-control shadow-sm form-percent">
                  </div>
                </form>
              </div>
            </div>
            ...
            <div class="card mb-3">
              <div class="card-header alert-info">
                <h5 class="mb-0" id="tituloRotacion"><i class="fas fa-sync-alt me-2"></i> OBJETIVOS TRIMESTRALES POR ROTACIÓN</h5>
              </div>
              <div class="card-body">
                <form class="row g-3">
                  <!-- Trimestre 1 y 2 -->
                  <div class="col-md-6" id="rotQ1">
                    <label for="Q1Rotacion"><i class="fas fa-dollar-sign me-2"></i>Objetivo Rotación (Q1)</label>
                    <input type="text" id="Q1Rotacion" class="form-control shadow-sm form-percent">
                  </div>
                  <div class="col-md-6" id="rotQ2">
                    <label for="Q2Rotacion"><i class="fas fa-dollar-sign me-2"></i>Objetivo Rotación (Q2)</label>
                    <input type="text" id="Q2Rotacion" class="form-control shadow-sm form-percent">
                  </div>

                  <!-- Trimestre 3 y 4 -->
                  <div class="col-md-6" id="rotQ3">
                    <label for="Q3Rotacion"><i class="fas fa-dollar-sign me-2"></i>Objetivo Rotación (Q3)</label>
                    <input type="text" id="Q3Rotacion" class="form-control shadow-sm form-percent">
                  </div>
                  <div class="col-md-6" id="rotQ4">
                    <label for="Q4Rotacion"><i class="fas fa-dollar-sign me-2"></i>Objetivo Rotación (Q4)</label>
                    <input type="text" id="Q4Rotacion" class="form-control shadow-sm form-percent">
                  </div>

                  <!-- Campo oculto -->
                  <div class="col-md-12" style="display: none">
                    <label for="anioRotacion"><i class="fas fa-dollar-sign me-2"></i>Objetivo Rotación Año</label>
                    <input type="text" id="anioRotacion" class="form-control shadow-sm form-percent">
                  </div>
                </form>
              </div>
            </div>
          ...
          <div class="card-body">
            ...
            <div class="mb-2">
              ...
              <div class="input-group">
                ...
                <input type="file" id="adjunto" name="adjunto" class="form-control shadow-sm" accept=".pdf">
              </div>
            </div>
            <!-- Campo Notas -->
            <div class="">
              ...
              <div class="input-group">
                ...
                <textarea class="form-control shadow-sm notas" id="txtNotas" rows="2"></textarea>
              </div>
            </div>
          </div>
        </div>
        <div class="d-flex justify-content-end gap-1 mt-2">
          <button type="button" class="btn btn-outline-primary btn-sm" id="btnGuardar">
            <i class="fas fa-floppy-disk me-2"></i> Guardar
          </button>
          <button type="button" class="btn btn-outline-secondary btn-sm" id="btnLimpiar" onclick="limpiarFormulario()">
    ...
    <!-- TAB SEGUIMIENTO -->
    <div class="tab-pane p-1 fade show" id="dvSeguimiento" role="tabpanel">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-md-7">
            <div class="form-group">
              <label for="filtroGeneral">Filtro</label>
              <input type="text" class="form-control form-control-sm shadow-sm" placeholder="Filtrar por cualquier columna" autocomplete="off" id="filtroGeneral">
            </div>
          </div>
          <div class="col-md-2">
            <div class="form-group">
              <label for="fechaInicio">Fecha Inicio</label>
              <input type="date" class="form-control form-control-sm shadow-sm" id="fechaInicio">
            </div>
          </div>
          <div class="col-md-2">
            <div class="form-group">
              <label for="fechaFin">Fecha Final</label>
              <input type="date" class="form-control form-control-sm shadow-sm" id="fechaFin">
            </div>
          </div>
          <div class="col-md-1 align-self-end">
            <button class="btn btn-outline-primary btn-sm w-100 shadow-sm" title="Refrescar grilla de datos de convenios" onClick="buscarConvenios();">
              <i class="fa-solid fa-floppy-disk"></i> Actualizar
            </button>
          </div>           
        </div>
      </div>
      <div id="dvResult" style="overflow: auto;"></div>
    </div>
  </div>

  <!-- MODAL SEGUIMIENTO CONVENIOS -->
    ...
    <div class="modal-dialog modal-fullscreen">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="row">
            <div class="col-md-9">
              <div class="card">
                <div class="card-header alert-info">
                  <h5 class="mb-0" id="tituloGrafico"><i class="fa-solid fa-chart-simple me-2"></i> CUMPLIMIENTO TRIMESTRAL GRAFICO</h5>
                </div>
                <div class="card-body">
            ...
            <div class="col-md-3 mb-3">
              <div class="card">
                <div class="card-header alert-info">
                  <h5 class="mb-0"><i class="fa-solid fa-list me-2"></i>CUMPLIMIENTO TOTAL AÑO</h5>
                </div>
                <div class="card-body p-0">
                  <ul class="list-group list-group-flush mb-3">
                    <li class="list-group-item mb-3">
                      <div class="row">
                        <div class="col-sm-9">
                          <h4 class="mb-0 me-4" id="detAnioCumplimientoTotal"></h4>
                        </div>
                        <div class="col-sm-3 text-center">
                          <i class="fa-solid fa-sack-dollar text-warning fa-2x "></i>
                          <p class="mb-0 no-wrap">Valor</p>
                        </div>
                      </div>
                    </li>

                    <div class="card-header alert-info d-flex align-items-center"> <i class="fa-solid fa-boxes-stacked me-2"></i>&nbsp;<h5>SELL IN</h5>
                    </div>
                    <li class="list-group-item">
                      <div class="row">
                        <div class="col-sm-9">
                          <h4 class="mb-0 me-4" id="detAnioObj"></h4>
                        </div>
                        <div class="col-sm-3 text-center"><i class="fa-solid fa-bullseye text-danger fa-2x "></i>
                    ...
                    <li class="list-group-item">
                      <div class="row">
                        <div class="col-sm-9">
                          <h4 class="mb-0 me-4" id="detAnioCompra"></h4>
                        </div>
                        <div class="col-sm-3 text-center"><i class="fa-brands fa-shopify text-success fa-2x "></i>
                    ...
                    <li class="list-group-item">
                      <div class="row">
                        <div class="col-sm-9">
                          <h4 class="mb-0 me-4" id="detAnioCumpleCompras"></h4>
                        </div>
                        <div class="col-sm-3 text-center"><i class="fa-solid fa-percent text-secondary fa-2x "></i>
                  ...
                  <ul class="list-group list-group-flush mb-3">
                    <div class="card-header alert-info d-flex align-items-center"> <i class="fa-solid fa-box me-2"></i>&nbsp;<h5>SELL OUT</h5>
                    </div>
                    <li class="list-group-item">
                      <div class="row">
                        <div class="col-sm-9">
                          <h4 class="mb-0 me-4" id="detAnioObjVentas"></h4>
                        </div>
                        <div class="col-sm-3 text-center"><i class="fa-solid fa-bullseye text-danger fa-2x "></i>
                          <p class="mb-0">Objetivo</p>
                        </div>
                    ...
                    <li class="list-group-item">
                      <div class="row">
                        <div class="col-sm-9">
                          <h4 class="mb-0 me-4" id="detAnioVentas"></h4>
                        </div>
                        <div class="col-sm-3 text-center"><i class="fa-solid fa-chart-line text-primary fa-2x "></i>
                    ...
                    <li class="list-group-item">
                      <div class="row">
                        <div class="col-sm-9">
                          <h4 class="mb-0 me-4" id="detAnioCumpleVentas"></h4>
                        </div>
                        <div class="col-sm-3 text-center"><i class="fa-solid fa-percent text-secondary fa-2x "></i>
                          <p class="mb-0">Cumpto.</p>
                        </div>
                ...
                <div class="card-body p-0">
                  <div id="dvComprasTrimestrales" class="collapse">
                    <div class="row justify-content-center g-3 p-3">
                      <!-- Trimestre Q1 -->
                      <div class="col-md-6 col-lg-3" id="columna1">
                        <div class="card h-100">
                          <div class="card-header bg-light" style="border-radius: 0;">
                            <h6 class="mb-0" style="color: #055160;" id="tituloCol1"><i class="fas fa-calendar me-2"></i>PRIMER TRIMESTRE Q1</h6>
                          </div>
                          ...
                          <div class="card-header bg-primary " style="border-radius: 0; color: #055160;">
                            <h6 class="mb-0"><i class="fas fa-bullsedanger"></i>REBATE POR IMPACTOS</h6>
                          </div>
                          <ul class="list-group list-group-flush">
                            <li class="list-group-item ">
                              <div class="d-flex justify-content-between align-items-center">
                            ...
                            <li class="list-group-item ">
                              <div class="d-flex justify-content-between align-items-center">
                                ...
                                <i class="fa-solid fa-person-circle-check text-info"></i>
                              </div>
                            </li>
                            <li class="list-group-item ">
                              <div class="d-flex justify-content-between align-items-center">
                          ...
                          <div class="card-header-warning">
                            <h6 class=" mb-0" id="tituloTotales1"><i class="fas fa-cash-register me-2"></i>VALOR TOTAL REBATE Q1</h6>
                          </div>
                          <ul class="list-group list-group-flush">
                            <li class="list-group-item">
                              <div class="d-flex justify-content-between align-items-center">
                      ...
                      <!-- Trimestre Q2 -->
                      <div class="col-md-6 col-lg-3" id="columna2">
                        <div class="card h-100">
                          <div class="card-header bg-light" style="border-radius: 0;">
                            <h6 class="mb-0" style="color: #055160;" id="tituloCol2"><i class="fas fa-calendar me-2"></i>SEGUNDO TRIMESTRE Q2</h6>
                          </div>
                          ...
                          <!-- Valor total rebate (Amarillo) -->
                          <div class="card-header-warning">
                            <h6 class="mb-0" id="tituloTotales2"><i class="fas fa-cash-register me-2"></i>VALOR TOTAL REBATE Q2</h6>
                          </div>
                          <ul class="list-group list-group-flush">
                            <li class="list-group-item">
                              <div class="d-flex justify-content-between align-items-center">
                      ...
                      <!-- Trimestre Q3 -->
                      <div class="col-md-6 col-lg-3" id="columna3">
                        <div class="card h-100">
                          <div class="card-header bg-light" style="border-radius: 0;">
                            <h6 class="mb-0" style="color: #055160;" id="tituloCol3"><i class="fas fa-calendar me-2"></i>TERCER TRIMESTRE Q3</h6>
                          </div>
                          ...
                          <!-- Valor total rebate (Amarillo) -->
                          <div class="card-header-warning">
                            <h6 class="mb-0" id="tituloTotales3"><i class="fas fa-cash-register me-2"></i>VALOR TOTAL REBATE Q3</h6>
                          </div>
                          <ul class="list-group list-group-flush">
                            <li class="list-group-item">
                              <div class="d-flex justify-content-between align-items-center">
                      ...
                      <!-- Trimestre Q4 -->
                      <div class="col-md-6 col-lg-3" id="columna4">
                        <div class="card h-100">
                          <div class="card-header bg-light" style="border-radius: 0;">
                            <h6 class="mb-0" style="color: #055160;" id="tituloCol4"><i class="fas fa-calendar me-2"></i>CUARTO TRIMESTRE Q4</h6>
                          </div>
                          ...
                          <!-- Valor total rebate (Amarillo) -->
                          <div class="card-header-warning">
                            <h6 class="mb-0" id="tituloTotales4"><i class="fas fa-cash-register me-2"></i>VALOR TOTAL REBATE Q4</h6>
                          </div>
                          <ul class="list-group list-group-flush">
                            <li class="list-group-item">
                              <div class="d-flex justify-content-between align-items-center">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-outline-primary btn-sm" id="verDetalle">Detalle Liquidación Rebate</button>
  ...
  <!-- MODAL LIQUIDACIÓN -->
  <div class="modal fade" id="modalLiquidacion" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-fullscreen">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title text-green">LIQUIDACIÓN Y GENERACIÓN DE NOTA</h4>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body" id="reporteLiquidacion">
  ...
  <div class="modal fade" id="ModalAdjunto" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
      <div class="modal-content text-center">
        <div class="modal-header" style="background-color: #CFF4FC; color: #055160;">
          <h5 class="modal-title" id="exampleModalLabel"> <i class="fa-solid fa-file mx-3"></i>DOCUMENTO ADJUNTO</h5>
