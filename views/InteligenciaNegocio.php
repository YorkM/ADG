...
<body>
    ...
    <div id="main-content">
        ...
        <div class="row shadow-sm py-2 w-90 mx-auto mb-3 mt-2" id=barraFiltros>
            ...
            <div class="col-3">
                <!-- <button class="btn btn-outline-success btn-sm btn-excel w-100" onclick="exportarExcel();">
            ...
            <div class="modal-content" style="background-color: whitesmoke;">
                ...
                <div class="modal-body">
                                                ...
                                                <div class="d-flex align-items-baseline gap-2 mt-2" id="adjCheck1">
                                                    ...
                                                    <div style="display: flex; align-items: center; gap: 40px;">
                                                        ...
                                                        <!-- <button class="btn btn-link"
                                                            style="width: 30px; height: 30px; font-size: 5px; display: flex;align-items: center;">
                    ...
                    <div class="row justify-content-center mb-5" id="sectionAnticipo">
                        <div class="col-10">
                            <h5 id="titleAnticipo">Adjuntar anticipo</h5>
                            <div class="card shadow-sm">
                                <div class="card-body">
