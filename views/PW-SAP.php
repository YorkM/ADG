...
<head>
  ...
  <meta charset="utf-8">
  <title>Módulo de pedidos WEB - SAP</title>
          ...
          <div class="row mt-2 mb-1 justify-content-center text-center flex-wrap">
            <div class="col-3 col-sm-3 col-lg-2 mb-1 d-flex justify-content-center">
              <button class="btn btn-sm btn-light btn-micro-two w-100 d-flex align-items-center justify-content-center" type="button" title="Bonificados" onclick="BotonBonificado(this)">
                <img src="../resources/icons/regalo.png" width="24" height="24" alt="PRODUCTO BONIFICADO" class="me-1">
                <span class="d-none d-sm-inline">Bonificado</span>
              </button>
            </div>
            <div class="col-3 col-sm-3 col-lg-2 mb-1 d-flex justify-content-center">
              <button class="btn btn-sm btn-light btn-micro-two w-100 d-flex align-items-center justify-content-center" type="button" title="Ofertas" onclick="BotonOfertas(this)">
                <img src="../resources/icons/pw/tag_marcado.png" width="24" height="24" alt="PRODUCTO OFERTADO" class="me-1">
                <span class="d-none d-sm-inline">Ofertas</span>
              </button>
            </div>
            <div class="col-3 col-sm-3 col-lg-2 mb-1 d-flex justify-content-center">
              <button class="btn btn-sm btn-light btn-micro-two w-100 d-flex align-items-center justify-content-center" type="button" title="Descuentos" onclick="BotonDescuentos(this)">
                <img src="../resources/icons/pw/tag_discount.png" width="24" height="24" alt="SOLO DESCUENTOS" class="me-1">
                <span class="d-none d-sm-inline">Descuentos</span>
              </button>
            </div>
            <div class="col-3 col-sm-3 col-lg-2 mb-1 d-flex justify-content-center">
              <button class="btn btn-sm btn-light btn-micro-two w-100 d-flex align-items-center justify-content-center" type="button" title="TOP 20 Productos" onclick="Top_20_mas_vendidos_con_copi(this)">
                <img src="../resources/icons/pw/top-10.png" width="24" height="24" alt="TOP 20" class="me-1">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="tab-content pt-3">
            <div class="tab-pane fade show active" id="ContenidoInfoMateriales" role="tabpanel" aria-labelledby="info-tab"></div>
              ...
              <table width="100%">
                <tbody>
                  <tr class="custom-tr">
                    ...
                    <td><input type="text" class="form-control shadow-sm size-th" id="shoping_codmaterial" readonly></td>
                  </tr>
                  <tr class="custom-tr">
                    <td class="vertical size-td">DESCRIPCIÓN</td>
                    <td><input type="text" class="form-control shadow-sm size-td text-green" id="shoping_descripcion" readonly></td>
                  </tr>
                  <tr class="custom-tr">
                    <td class="vertical size-td">VALOR ACTUAL</td>
                    <td><input type="text" class="form-control shadow-sm size-th" id="shoping_preciomaterial" readonly></td>
                  </tr>
                  <tr class="custom-tr">
                  ...
                  <tr class="custom-tr">
                    ...
                    <td><input type="number" class="form-control shadow-sm size-th" id="shoping_valor"></td>
                  </tr>
                  <tr class="custom-tr">
                    <td class="vertical size-td">OBSERVACIÓN</td>
                    <td><input type="text" class="form-control shadow-sm size-td" id="shoping_observacion"></td>
                  </tr>
                  <tr class="custom-tr">
                    <td colspan="2">
            ...
            <div class="tab-pane fade" id="ContenidoHuellaMateriales" role="tabpanel" aria-labelledby="huella-tab">
              ...
              <input type="hidden" class="form-control shadow-sm" id="huella_stock" readonly>
              <input type="hidden" class="form-control shadow-sm" id="huella_dcto" readonly>
              <table width="100%">
                <tbody>
                  <tr class="custom-tr">
                    <td class="vertical size-td">CODIGO</td>
                    <td><input type="text" class="form-control shadow-sm size-th" id="huella_codmaterial" readonly></td>
                  </tr>
                  <tr class="custom-tr">
                    <td class="vertical size-td">DESCRIPCIÓN</td>
                    <td><input type="text" class="form-control shadow-sm size-td text-green" id="huella_descripcion" readonly></td>
                  </tr>
                  <tr class="custom-tr">
                    <td class="vertical size-td">CANTIDAD</td>
                    <td><input type="number" class="form-control shadow-sm size-th" id="huella_cantidad"></td>
                  </tr>
                  <tr class="custom-tr">
                    <td class="vertical size-td">OBSERVACIÓN</td>
                    <td><input type="text" class="form-control shadow-sm size-td text-green" id="huella_notas"></td>
                  </tr>
                  <tr class="custom-tr">
                    <td colspan="2">
