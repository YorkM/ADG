...
.thumbnail {
    height: 400px; /* Establece la altura fija para cada tarjeta */
}
</style>
<!------------------------------------------------------------------------------------------------------------------>
...
<input type="hidden" id="AbrirVentas"  value="<?php if(!empty($_GET["grupo"])){ echo $_GET["grupo"] ;}else{echo 0;}?>" readonly>
  ...
  <div class="panel-body">
    <div class="tab-content">
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <table class="form" width="100%">
                  ...
                  <tr>
                    <td>Vendedor</td>
                    <td><div class="input-group"> <span class="input-group-addon" id="basic-addon1"> <span class="glyphicon glyphicon-user" aria-hidden="true"></span> </span>
      ...
      <div class="tab-pane fade" id="dvProductos"> 
            ...
            <thead>
              <tr>
                <th align="center">&nbsp; &nbsp; &nbsp;VALOR TOTAL PEDIDO -
                  <input type="text" id="txt_total" class="sin_borde" readonly disabled></th>
              </tr>
            </thead>
          </table>
        </div>
        <table class="form" width="100%">
          <tr>
            <td colspan="2"><div id="n_resultados" class="n_resultados"></div></td>
          </tr>
          <tr>
            <td width="100%"><div class="row">
                <div class="col-md-12">
          ...
          <tbody>
            ...
            <tr>
              <td colspan="3"><button class="btn btn-info btn-sm" onClick="GestionPedidos();">Buscar</button>
                ...
                <button class="btn btn-success btn-sm" id="exportar_gestion">Exportar</button></td>
            </tr>
          </tbody>
        </table>
      ...
      <div class="tab-pane fade" id="dvAddEntregas">
        ...
        <table class="form" align="center" width="100%">
          ...
          <tbody>
            ...
            <tr>
              <td colspan="3"><div class="btn-group" role="group" aria-label="...">
          ...
          <tbody>
            ...
            <tr>
              <td colspan="3"><button class="btn btn-info btn-sm" onClick="ListarFacturas();">Buscar</button>
                <button class="btn btn-default btn-sm" onClick="LimpiarFacturas();">Limpiar</button></td>
            </tr>
          </tbody>
        </table>
          ...
          <tbody>
            ...
            <tr>
              <td colspan="3"><button class="btn btn-info btn-sm" onClick="Faltante();">Buscar</button>
                ...
                <button class="btn btn-default btn-sm" onClick="LimpiarFaltantes();">Limpiar</button></td>
            </tr>
          </tbody>
        </table>
