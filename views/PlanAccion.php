            ...
            <div class="tab-pane fade show active " id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                <div class="alert alert-danger d-flex justify-content-center align-items-center gap-3 mb-3 mt-2" role="alert">
                    ...
                    <div style="font-weight: 500;">
                        Diligenciar en los primeros 5 días del mes !!!
                    </div>
                </div>
                <div style="width: 95%; margin: 0 auto;">
                        ...
                        <div class="row shadow-sm px-3 py-4" style="background-color: whitesmoke;">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="" id="proceso" class="form-select form-select-sm">
                                        ...
                                        <option value="">Prueba 4</option>
                                        <option value="">Prueba 5</option>
                                    </select>
                                </div>
                                <div class="form-group mt-2">
                                    <label for="periodo">Periodo</label>
                                    <select name="" id="periodo" class="form-select form-select-sm">
                                ...
                                <div class="form-group mt-2">
                                    ...
                                    <input type="text" class="form-control form-control-sm" id="meta" placeholder="% Meta">
                                </div>
                                <div class="form-group mt-2">
                                    <label for="rango">Rango</label>
                                    <div class="d-flex gap-2">
                                        <input type="text" class="form-control form-control-sm" id="rangoIni" placeholder="% Rango inicial">
                                        <input type="text" class="form-control form-control-sm" id="rangoFin" placeholder="% Rango final">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="" class="form-control form-control-sm bg-custom-input" id="objetivos"></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="causaRaiz">Causa raíz</label>
                                    <textarea name="" class="form-control form-control-sm bg-custom-input" id="causaRaiz"></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="indicador">Indicador</label>
                                    <textarea name="" class="form-control form-control-sm bg-custom-input" id="indicador"></textarea>
                                </div>
                                <div class="d-flex align-items-baseline gap-5 mt-2">
                                    <p style="font-weight: 600;">ACCIONES</p>
                                    <button class="btn-accion-style" id="btnAgregarAcciones" style="height: max-content;">
                    ...
                    <div class="d-flex justify-content-center mt-3">
                        <button class="btn-guardar" id="btnGuardarPlan">Guardar plan</button>
                    </div>
                </div>
            </div>
            <div class="tab-pane fade p-2" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                ...
                <div style="overflow: auto;">
                    <table id="tablaDatos" class="table table-sm table-bordered table-hover" style="width: 100%;">
                        ...
                        <tbody id="tableBody">
                            <tr>
                                <td class="align-tds">PRUEBA</td>
                                <td class="align-tds">MENSUAL</td>
                                <td class="align-tds">65</td>
                                <td class="align-tds">50</td>
                                <td class="align-tds">90</td>
                                <td class="align-tds">PRUEBA</td>
                                <td class="align-tds">PRUEBA</td>
                                <td class="align-tds">PRUEBA</td>
                                <td class="text-center">
                                    <button class="btn-accion-style btn-accion"><i class="fa-solid fa-circle-plus"></i></button>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                ...
                <!-- <div style="overflow: auto;">
                    <table id="tablaDatos" class="table table-sm table-bordered table-hover" style="width: 100%;">
                        ...
                        <tbody id="tableBody">
                            <tr>
                                <td>
                                    <p style="display: inline; width: 50%;">Prueba 1</p>
                                    <input type="text" class="form-control form-control-sm w-50" id="" placeholder="Indice">
                                </td>
                                <td>
                                    <p style="display: inline; width: 50%;">2025-04-01</p>
                                    <input type="text" class="form-control form-control-sm w-50" id="" placeholder="Avance">
                                </td>
                                <td>
                                    <p style="display: inline; width: 50%;">2025-04-03</p>
                                    <input type="text" class="form-control form-control-sm w-50" id="" placeholder="Resultado">
                                </td>
                                <td>
                                    <p style="display: inline; width: 50%;">Pedro Fernández</p>
                                    <input type="text" class="form-control form-control-sm w-50" id="" placeholder="Estado">
                                </td>
                            </tr>                               
                        </tbody>
                    </table>
